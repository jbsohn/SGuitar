...
JNIChordRecord::JNIChordRecord() = default;

JNIChordRecord::~JNIChordRecord() = default;

auto JNIChordRecord::fromCpp(JNIEnv* jniEnv, const CppType& c) -> ::djinni::LocalRef<JniType> {
...
auto JNIChordRecord::toCpp(JNIEnv* jniEnv, JniType j) -> CppType {
