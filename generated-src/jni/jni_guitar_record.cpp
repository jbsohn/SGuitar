...
JNIGuitarRecord::JNIGuitarRecord() = default;

JNIGuitarRecord::~JNIGuitarRecord() = default;

auto JNIGuitarRecord::fromCpp(JNIEnv* jniEnv, const CppType& c) -> ::djinni::LocalRef<JniType> {
    ...
    auto r = ::djinni::LocalRef<JniType>{jniEnv->NewObject(data.clazz.get(), data.jconstructor,
                                                           ...
                                                           ::djinni::get(::djinni::Array<::djinni_generated::JNIGuitarStringRecord, ::djinni::JavaClassName<'c','o','m','/','s','t','e','e','l','s','i','d','e','k','i','c','k','/','s','g','u','i','t','a','r','/','G','u','i','t','a','r','S','t','r','i','n','g','R','e','c','o','r','d'>>::fromCpp(jniEnv, c.guitar_strings)),
                                                           ::djinni::get(::djinni::Array<::djinni_generated::JNIGuitarAdjustmentRecord, ::djinni::JavaClassName<'c','o','m','/','s','t','e','e','l','s','i','d','e','k','i','c','k','/','s','g','u','i','t','a','r','/','G','u','i','t','a','r','A','d','j','u','s','t','m','e','n','t','R','e','c','o','r','d'>>::fromCpp(jniEnv, c.guitar_adjustments)))};
    ::djinni::jniExceptionCheck(jniEnv);
    return r;
}

auto JNIGuitarRecord::toCpp(JNIEnv* jniEnv, JniType j) -> CppType {
