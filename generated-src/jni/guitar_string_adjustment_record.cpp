...
#include "guitar_string_adjustment_record.hpp"  // my header
#include "Marshal.hpp"

namespace djinni_generated {

GuitarStringAdjustmentRecord::GuitarStringAdjustmentRecord() = default;
...
auto GuitarStringAdjustmentRecord::toCpp(JNIEnv* jniEnv, JniType j) -> CppType {
