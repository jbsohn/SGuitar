...
CJNIEXPORT jstring JNICALL Java_com_steelsidekick_sguitar_StringAdjustment_00024CppProxy_native_1getDescription(JNIEnv* jniEnv, jobject /*this*/, jlong nativeRef)
{
    try {
        const auto& ref = ::djinni::objectFromHandleAddress<::StringAdjustment>(nativeRef);
