...
namespace SG {
    ...
    public:
        ...
        std::vector<int> getNoteValues() const { return chordNoteValues; }
        int getNumberOfScaleNotes() const { return (int) chordNoteValues.size(); }
        int getScaleNote(int index) const { return chordNoteValues[index]; }
